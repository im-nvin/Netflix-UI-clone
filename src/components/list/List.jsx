...
function List() {
    ...
    const [isMoved, setIsMoved] = useState(false) //it is used to make appear left slider button only when slider is moved
    ...
    return (
        <div className='list'>
            ...
            <div className="wrapper">
                ...
                <div className="container left" ref={listRef}>
